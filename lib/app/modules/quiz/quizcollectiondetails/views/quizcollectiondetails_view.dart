...
class QuizcollectiondetailsView
    extends GetView<QuizcollectiondetailsController> {
  const QuizcollectiondetailsView({Key? key}) : super(key: key);
  @override
      ...
      child: Column(
        ...
        children: [
          Stack(
            children: [
              CommonImageView(
                imagePath: ImageConstant.pngAfricanBeauty,
              ),
              QuahaAppBar(
          ...
          Column(
            ...
            children: [
              Text(
                'Branding & Marketing',
                style:
                    TextStyleUtil.rubik500(fontSize: 14.kh, letterSpacing: 1),
              ),
              Text('African Branding',
